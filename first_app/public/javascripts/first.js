...
//private linear supply curve
	...
	var MPBexplanation = d3.tip()
  		.attr("class", "hoverbox above")
		.offset([10, -3])
		.html("MPB line: This line represents the private benefit (what the consumer will pay) to purchase one more unit, without including the benefits generated by the externality.")
 
		chart.call(MPBexplanation)
	...
	var mpbText = chart.append("text")
    	...
    	.on('mouseover', MPBexplanation.show)
      	.on('mouseout', MPBexplanation.hide)
  		.append("textPath")
	...
	var msbPath = chart.append("path")
    	.attr("id", "path1")
    	.attr("d", "M 330,199 L 430,245");
    var mpb = d3.select("#demand")

	var MSBexplanation = d3.tip()
  		.attr("class", "hoverbox above")
		.offset([10, -3])
		.html("MSB line: This line represents the social benefit – that is, the private benefit plus all other externally realized benefits, of producing one more unit. It is higher than the private benefit for all levels of production.")
 
		chart.call(MSBexplanation)
   ...
   var q1explanation = d3.tip()
  		.attr("class", "hoverbox above")
		.offset([-10, -3])
		.html("Q*: This is the market-clearing quantity at which supply equals demand, without adjusting for the externality. The quantity is lower than what it would be if the external benefits were included.")
	...
	var DWLexplanation = d3.tip()
  		.attr("class", "hoverbox right")
		.offset([72, 105])
		.html("Deadweight loss: This represents the additional “wasted” resources allocated to this good because of an unadjusted externality. It is “wasted” in that it reflects total costs in excess of the benefit to consumers.")
	...
	function stage0f(){
			...
			var msbText = chart.append("text")
				...
				.attr({'class':'edgelabel',
    	        	   ...
    	        	   'font-size':10,
        		       'fill':'orange'})
		    	.on("mouseover", MSBexplanation.show)
		    	.on("mouseout", MSBexplanation.hide)
		  		.append("textPath")
		    		//.attr("class", "textpath")
